...
const Sidebar: React.FC<SidebarProps> = ({ width, isCollapsed, onToggle, prompt }) => {
          ...
          <div className="px-[14px] pb-4 pt-4">
            <div className="bg-[#27272a] rounded-[26px] p-3.5 relative flex flex-col gap-2 shadow-lg border border-white/5">
               <textarea 
                  ...
                  className="w-full bg-transparent text-gray-100 placeholder-gray-400 resize-none outline-none min-h-[44px] px-3 py-1.5 text-[16px] leading-relaxed font-normal overflow-y-auto"
                  value={promptValue}
