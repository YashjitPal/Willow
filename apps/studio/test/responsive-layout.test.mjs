...
test('Chat prompt box matches Gemini 3-tier specs: 64px desktop, 72px tablet, 80px mobile', () => {
  ...
  assert.match(composer, /pt-4 pb-\[62px\] max-\[960px\]:pt-6 min-\[769px\]:max-\[960px\]:pb-\[68px\] max-\[768px\]:pb-\[72px\]/);
  ...
  // Left padding of collapsed textarea on tablet/mobile matches Gemini (26px gap on tablet, 28px gap on mobile):
