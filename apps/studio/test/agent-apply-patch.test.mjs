 ...
 *
 * This is the one place in the Agent tool where a bug silently corrupts a user's
...
const patcher = await importTs(
  path.join(repoRoot, 'features', 'code', 'src', 'agent', 'harness', 'runtime', 'apply-patch.ts'),
);
