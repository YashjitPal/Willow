 ...
 * filesystem. Code Beta drives a browser sandbox that can do exactly one thing:
 ...
 * coherently.
 */
const WILLOW_PREAMBLE = `You are the coding agent inside Willow Code Beta, a browser-based app builder. You are expected to be precise, safe, and helpful.
 ...
 */
export function toolProtocolSection(applyPatchInstructions: string): string {
