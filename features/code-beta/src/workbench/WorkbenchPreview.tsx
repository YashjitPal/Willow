...
// Code Beta: lets the harness's computer_use tool reach the preview frame.
import { setPreviewFrame } from "../code-beta-store";
...
const MainPreview: React.FC<MainPreviewProps> = ({
  ...
  /*
   * Code Beta: publish the preview frame so the harness's `computer_use` tool
   * can screenshot and drive it.
   *
