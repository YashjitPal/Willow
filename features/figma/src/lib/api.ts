/**
 * Willow Figma — typed REST client for the planned Figma backend.
 *
 * UNFINISHED. No such backend exists in this repo yet; this file is the
 * contract a future service would implement, under `/figma-api/v1`
 * (same-origin in dev via Vite middleware, or standalone on
 * http://127.0.0.1:8788 with the same prefix).
 *
 * See ../../README.md for what else this feature is still missing.
 */
