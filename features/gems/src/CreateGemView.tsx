...
export const CreateGemView: React.FC = () => {
  ...
  return (
    <div style={{
      ...
      background: isLight ? 'var(--studio-surface, #faf9f9)' : '#131314'
    }}>
      <style>{`
        ...
        .default-tool-btn:hover, .default-tool-btn:focus, .default-tool-btn[data-open="true"] {
          background-color: ${isLight ? 'rgba(0, 0, 0, 0.05)' : 'rgba(227, 227, 227, 0.08)'} !important;
        }
        @font-face {
        ...
        ::placeholder {
          color: ${isLight ? '#747775' : 'rgb(196, 199, 197)'};
          opacity: 1;
        }
        ::-webkit-scrollbar {
          display: none;
      ...
      <div style={{
        ...
        gap: '24px',
        padding: '24px',
        background: isLight ? '#ffffff' : 'rgb(27, 27, 27)',
        borderRadius: '24px',
        border: isLight ? '1px solid #e3e3e3' : 'none',
        boxShadow: isLight ? '0 1px 3px 0 rgba(60,64,67,0.1), 0 4px 8px 3px rgba(60,64,67,0.05)' : 'none',
        width: '100%',
        maxWidth: '1246px',
        position: 'relative',
        margin: '0',
        ...
        <div style={{ flex: '1 1 0%', position: 'relative', display: 'flex', flexDirection: 'column', height: '100%' }}>
          ...
          <div style={{
            ...
            <button
              ...
              style={{
                ...
                color: isLight ? 'rgb(31, 31, 31)' : 'rgb(196, 199, 197)',
                cursor: 'pointer',
                border: 'none',
                display: 'flex',
                alignItems: 'center',
            ...
            <div style={{
              ...
              height: '50px',
              borderRadius: '50%',
              backgroundColor: isLight ? 'rgb(240, 244, 249)' : 'rgb(25, 29, 28)',
              display: 'flex',
              alignItems: 'center',
              justifyContent: 'center',
              flexShrink: 0
              ...
              <span className="material-symbols-outlined" style={{ 
                ...
                fontSize: '28.125px', 
                color: isLight ? 'rgb(68, 71, 70)' : 'rgb(169, 172, 170)',
                lineHeight: '28.125px',
                userSelect: 'none'
              }}>
                gem_spark
          ...
          <div style={{ display: 'flex', flexDirection: 'column', flex: 1, overflowY: 'auto', overflowX: 'hidden', minHeight: 0, width: '100%' }}>
            <label style={{ display: 'block', margin: '8px 0px', fontSize: '13px', fontWeight: 400, fontFamily: '"Google Sans Flex", "Google Sans", "Helvetica Neue", sans-serif', color: isLight ? 'rgb(31, 31, 31)' : 'rgb(227, 227, 227)', flexShrink: 0 }}>
              Name
            </label>
            <div style={{
              width: '100%',
              minHeight: '56px',
              padding: '16px',
              backgroundColor: isLight ? '#ffffff' : 'rgb(19, 19, 20)',
              borderRadius: '8px',
              display: 'flex',
              alignItems: 'center',
              border: `1.6px solid ${isNameError ? (isLight ? 'rgb(179, 38, 30)' : 'rgb(242, 184, 181)') : nameFocused ? (isLight ? 'rgb(11, 87, 208)' : 'rgb(168, 199, 250)') : (isLight ? 'rgb(225, 227, 225)' : 'rgba(0, 0, 0, 0)')}`,
              boxSizing: 'border-box',
              flexShrink: 0
            }}>
              <div style={{ width: '100%', boxSizing: 'border-box', display: 'flex' }}>
                <input
                  ...
                  style={{
                    ...
                    backgroundColor: isLight ? '#ffffff' : 'rgb(19, 19, 20)',
                    fontSize: '16px',
                    color: isLight ? 'rgb(31, 31, 31)' : 'rgb(230, 230, 230)',
                    fontFamily: '"Google Sans Flex", "Google Sans", "Helvetica Neue", sans-serif',
                    border: 'none',
                    outline: 'none',
                    width: '100%'
              ...
              {isNameError && (
                <MaterialSymbol name="error" family="google-symbols" size={24} style={{ color: isLight ? 'rgb(179, 38, 30)' : 'rgb(242, 184, 181)', marginLeft: '8px' }} />
              )}
            </div>
            <div style={{ height: '20px', fontSize: '12px', flexShrink: 0, display: 'flex', alignItems: 'center', padding: '0px 16px' }}>
              {isNameError && (
                <span style={{ color: isLight ? 'rgb(179, 38, 30)' : 'rgb(242, 184, 181)', fontFamily: '"Google Sans Flex", "Google Sans", "Helvetica Neue", sans-serif' }}>
            ...
            <div style={{
              ...
              display: 'flex',
              alignItems: 'stretch',
              border: `1.6px solid ${descFocused ? (isLight ? 'rgb(11, 87, 208)' : 'rgb(168, 199, 250)') : (isLight ? 'rgb(225, 227, 225)' : 'rgba(0, 0, 0, 0)')}`,
              boxSizing: 'border-box',
              flexShrink: 0
            }}>
              <textarea
            ...
            <div style={{ display: 'flex', alignItems: 'center', height: '40px', margin: '0px', width: '100%', flexShrink: 0 }}>
              <label style={{ display: 'block', margin: '8px 0px', fontSize: '13px', fontWeight: 400, fontFamily: '"Google Sans Flex", "Google Sans", "Helvetica Neue", sans-serif', color: isLight ? 'rgb(31, 31, 31)' : 'rgb(227, 227, 227)', width: 'auto' }}>
                Instructions
              </label>
              <button style={{
                width: '40px',
            ...
            <div style={{
              ...
              backgroundColor: isLight ? '#ffffff' : 'rgb(19, 19, 20)',
              borderRadius: '8px',
              border: `1.6px solid ${instFocused ? (isLight ? 'rgb(11, 87, 208)' : 'rgb(168, 199, 250)') : (isLight ? 'rgb(225, 227, 225)' : 'rgba(0, 0, 0, 0)')}`,
              display: 'flex',
              flexDirection: 'column',
              boxSizing: 'border-box'
            }}>
              ...
              <div style={{ display: 'flex', alignItems: 'normal', margin: '0px', padding: '8px' }}>
                <button style={{
                  width: '40px', height: '40px', padding: '8px 6px 8px 8px', backgroundColor: isLight ? 'rgb(240, 244, 249)' : 'rgb(48, 48, 48)',
                  borderRadius: '9999px 0px 0px 9999px', border: 'none',
                  display: 'flex', alignItems: 'center', justifyContent: 'center'
                }}>
                  <span className="material-symbols-outlined" style={{ fontFamily: '"Google Symbols"', fontSize: '24px', color: isLight ? 'rgba(0, 0, 0, 0.38)' : 'rgba(227, 227, 227, 0.38)', userSelect: 'none' }}>undo</span>
                </button>
                <button style={{
                  width: '40px', height: '40px', padding: '8px 8px 8px 6px', backgroundColor: isLight ? 'rgb(240, 244, 249)' : 'rgb(48, 48, 48)',
                  borderRadius: '0px 9999px 9999px 0px', border: 'none', margin: '0',
                  display: 'flex', alignItems: 'center', justifyContent: 'center'
                }}>
                  <span className="material-symbols-outlined" style={{ fontFamily: '"Google Symbols"', fontSize: '24px', color: isLight ? 'rgba(0, 0, 0, 0.38)' : 'rgba(227, 227, 227, 0.38)', userSelect: 'none' }}>redo</span>
                </button>
                <button style={{
                  width: '40px', height: '40px', padding: '0px 12px', backgroundColor: isLight ? 'rgb(240, 244, 249)' : 'rgb(48, 48, 48)',
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: '4px', margin: '24px 0px 8px', width: '100%', height: '40px', flexShrink: 0 }}>
              <div style={{ fontSize: '13px', fontWeight: 400, color: isLight ? 'rgb(31, 31, 31)' : 'rgb(227, 227, 227)', fontFamily: '"Google Sans Flex", "Google Sans", "Helvetica Neue", sans-serif' }}>
                Default tool
              </div>
              <button style={{
                width: '40px', height: '40px', padding: '8px', borderRadius: '9999px', backgroundColor: 'transparent',
                color: isLight ? 'rgb(68, 71, 70)' : 'rgb(196, 199, 197)', border: 'none', cursor: 'pointer', display: 'flex', alignItems: 'center', justifyContent: 'center'
              }}
              onMouseEnter={(e) => e.currentTarget.style.backgroundColor = isLight ? 'rgba(0, 0, 0, 0.05)' : 'rgba(255, 255, 255, 0.08)'}
              onMouseLeave={(e) => e.currentTarget.style.backgroundColor = 'transparent'}
              >
              ...
              <button 
                ...
                style={{
                  ...
                  color: isLight ? 'rgb(31, 31, 31)' : 'rgb(227, 227, 227)', border: 'none', display: 'flex', alignItems: 'center', justifyContent: 'center',
            ...
            <div style={{ margin: '20px 0px 0px', display: 'flex', alignItems: 'center', width: '100%', flexShrink: 0 }}>
              <label style={{ display: 'block', margin: '8px 0px', fontSize: '13px', fontWeight: 400, fontFamily: '"Google Sans Flex", "Google Sans", "Helvetica Neue", sans-serif', color: isLight ? 'rgb(31, 31, 31)' : 'rgb(227, 227, 227)' }}>
                Knowledge
              </label>
              <button style={{
                width: '40px', height: '40px', padding: '10px', borderRadius: '9999px', backgroundColor: 'transparent',
                color: isLight ? 'rgb(68, 71, 70)' : 'rgb(196, 199, 197)', border: 'none', cursor: 'pointer', display: 'flex', alignItems: 'center', justifyContent: 'center', marginLeft: '8px'
              }}
              onMouseEnter={(e) => e.currentTarget.style.backgroundColor = isLight ? 'rgba(0, 0, 0, 0.05)' : 'rgba(255, 255, 255, 0.08)'}
              onMouseLeave={(e) => e.currentTarget.style.backgroundColor = 'transparent'}
              >
            ...
            <div style={{ backgroundColor: isLight ? '#ffffff' : 'rgb(19, 19, 20)', border: isLight ? '1px solid rgb(225, 227, 225)' : 'none', borderRadius: '8px', padding: '8px 0px', display: 'flex', alignItems: 'stretch', width: '100%', height: '58px', boxSizing: 'border-box', flexShrink: 0 }}>
              <div style={{ margin: '0px 16px', display: 'flex', alignItems: 'center', justifyContent: 'space-between', width: '100%' }}>
                <span style={{ fontSize: '17px', fontFamily: '"Google Sans Flex", "Google Sans", "Helvetica Neue", sans-serif', color: isLight ? 'rgb(68, 71, 70)' : 'rgb(196, 199, 197)' }}>
                  Add files for your Gem to reference
                </span>
                <button style={{ background: 'transparent', border: 'none', color: isLight ? 'rgb(31, 31, 31)' : 'rgb(227, 227, 227)', display: 'flex', alignItems: 'center', justifyContent: 'center', cursor: 'pointer' }}>
              ...
              <div style={{ display: 'block', margin: '0px', height: '40px' }}>
                <label style={{ display: 'flex', alignItems: 'center', cursor: 'default' }}>
                  <div style={{ position: 'relative', width: '40px', height: '40px', display: 'flex', alignItems: 'center', justifyContent: 'center', flexShrink: 0 }}>
                    <div style={{ width: '18px', height: '18px', border: isLight ? '1.6px solid rgba(0, 0, 0, 0.38)' : '1.6px solid rgba(227, 227, 227, 0.38)', borderRadius: '2px', backgroundColor: 'transparent', boxSizing: 'border-box' }}></div>
                  </div>
                  <span style={{ fontSize: '14px', fontWeight: 400, fontFamily: '"Google Sans Flex", "Google Sans Text", "Google Sans", sans-serif', color: isLight ? 'rgba(0, 0, 0, 0.38)' : 'rgba(227, 227, 227, 0.38)', margin: '0px', padding: '0px' }}>
        ...
        <div style={{ flex: '1 1 0%', position: 'relative', display: 'flex', flexDirection: 'column', height: '100%' }}>
          <div style={{ height: '50px', marginBottom: '24px', display: 'flex', alignItems: 'center', justifyContent: 'flex-end', flexShrink: 0, gap: '16px' }}>
            {hasUnsavedChanges && (
              <div style={{
                color: isLight ? 'rgb(116, 119, 117)' : 'rgb(142, 145, 143)',
                fontSize: '15px',
                fontWeight: 400,
                fontFamily: '"Google Sans Flex", "Google Sans", "Helvetica Neue", sans-serif',
                fontStyle: 'italic',
            ...
            <button
              ...
              style={{
                height: '40px',
                padding: '0px 24px',
                backgroundColor: canSave ? (isLight ? 'rgb(11, 87, 208)' : 'rgb(168, 199, 250)') : (isLight ? 'rgba(0, 0, 0, 0.06)' : 'rgba(227, 227, 227, 0.12)'),
                borderRadius: '40px',
                color: canSave ? (isLight ? '#ffffff' : 'rgb(6, 46, 111)') : (isLight ? 'rgba(0, 0, 0, 0.38)' : 'rgba(227, 227, 227, 0.38)'),
                fontSize: '14px',
                fontWeight: 500,
                fontFamily: '"Google Sans Flex", "Google Sans Text", "Google Sans", sans-serif',
                border: 'none',
          ...
          <div style={{ display: 'flex', flexDirection: 'column', flex: 1, overflowY: 'auto', minHeight: 0 }}>
            <label style={{ margin: '8px 0px', fontSize: '13px', fontWeight: 400, color: isLight ? 'rgb(31, 31, 31)' : 'rgb(227, 227, 227)', display: 'block', fontFamily: '"Google Sans Flex", "Google Sans", "Helvetica Neue", sans-serif', flexShrink: 0 }}>
              Preview
            </label>
          <div style={{ display: 'flex', flexDirection: 'column', flex: 1, minHeight: 0, borderRadius: '8px', position: 'relative', overflow: 'hidden' }}>
            <div style={{
              ...
              padding: '0px 48px',
              backgroundColor: isLight ? 'rgba(240, 244, 249, 0.95)' : 'rgba(19, 19, 20, 0.8)',
              display: 'flex',
              alignItems: 'center',
              justifyContent: 'center',
              width: '100%',
            ...
            <div style={{
              ...
              backgroundColor: isLight ? '#ffffff' : 'rgb(19, 19, 20)',
              border: isLight ? '1px solid #e3e3e3' : 'none',
              boxShadow: isLight ? '0 1px 3px 0 rgba(60,64,67,0.1)' : 'none',
              color: isLight ? 'rgba(0, 0, 0, 0.38)' : 'rgba(227, 227, 227, 0.38)',
              borderRadius: '32px',
              marginBottom: '16px',
              boxSizing: 'border-box'
            }}>
              <button style={{
                ...
                color: isLight ? 'rgba(0, 0, 0, 0.38)' : 'rgba(227, 227, 227, 0.38)', border: 'none', display: 'flex', alignItems: 'center', justifyContent: 'center'
              }}>
                <MaterialSymbol name="add" size={24} />
              </button>
              ...
              <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'flex-end', gap: '8px' }}>
                <button style={{
                  ...
                  backgroundColor: 'transparent', opacity: 0.38, color: isLight ? 'rgba(0, 0, 0, 0.38)' : 'rgba(227, 227, 227, 0.38)', border: 'none', display: 'flex', alignItems: 'center', fontFamily: '"Google Sans Flex", "Google Sans", "Helvetica Neue", sans-serif'
                }}>
                  Flash <MaterialSymbol name="arrow_drop_down" size={20} />
                </button>
                <button style={{
                  width: '32px', height: '32px', borderRadius: '50%', backgroundColor: 'transparent', color: isLight ? 'rgba(0, 0, 0, 0.38)' : 'rgba(227, 227, 227, 0.38)', border: 'none', display: 'flex', alignItems: 'center', justifyContent: 'center'
                }}>
          ...
          >
            {TOOL_MENU_ITEMS.map((item, i) => (
              <button
                ...
                onMouseEnter={(e) => e.currentTarget.style.backgroundColor = isLight ? 'rgba(0, 0, 0, 0.05)' : 'rgba(227, 227, 227, 0.12)'}
                onMouseLeave={(e) => e.currentTarget.style.backgroundColor = 'transparent'}
              >
                <MaterialSymbol name={item.icon} family={item.family as any} size={24} style={{ color: isLight ? 'rgb(68, 71, 70)' : 'rgb(196, 199, 197)' }} />
                <span>{item.text}</span>
