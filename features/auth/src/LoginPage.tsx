...
import { Button } from "@willow/ui/button";
import { Input } from "@willow/ui/input";
import { Label } from "@willow/ui/label";
import { Checkbox } from "@willow/ui/checkbox";
...
export function LoginPage() {
  ...
  // Read mode from URL params (?mode=signup or ?mode=login)
  const modeFromUrl = searchParams.get('mode');
  const [isSignUp, setIsSignUp] = useState(modeFromUrl === 'signup');
          ...
          <form onSubmit={handleEmailPasswordSubmit} className="willow-login__form space-y-5">
            <div className="space-y-2">
              ...
              <Input
                ...
                required
                className="h-12 bg-[#1a1a1a] border-white/10 text-white placeholder:text-white/40 focus:border-violet-500"
              />
            </div>
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                <Input
                  ...
                  required
                  className="h-12 pr-10 bg-[#1a1a1a] border-white/10 text-white placeholder:text-white/40 focus:border-violet-500"
                />
                <button
                  type="button"
          ...
          <div className="willow-login__toggle text-center text-sm text-white/60 mt-8">
            ...
            <button 
              onClick={() => {
                ...
                setError("");
                setSuccess("");
                // Update URL to keep it in sync with the current tab
                navigate(`/login?mode=${newMode ? 'signup' : 'login'}`, { replace: true });
              }}
