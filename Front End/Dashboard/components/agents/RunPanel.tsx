...
import { CheckCircle2, Loader2, XCircle, X, Play, ThumbsUp, ThumbsDown, Square } from 'lucide-react';
          ...
          <div className="px-5 py-3 border-b border-[#2b2b2b]">
            <div className="flex items-center gap-2">
              <input
                ...
                onKeyDown={(e) => { if (e.key === 'Enter' && !isActive) backend.run(input || 'Hello'); }}
              ...
              <button
                disabled={isActive}
                onClick={() => backend.run(input || 'Hello')}
