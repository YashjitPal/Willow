...
function App() {
  ...
  const handleRoleSelect = (roleId: string) => {
    ...
    // Add small delay or just wait for user to click Next? 
    // Let's require explicit Next click for better UX flow control
  };
  ...
  return (
    <div className="min-h-screen w-full bg-black flex flex-col items-center justify-center relative overflow-hidden font-sans text-white selection:bg-green-500/30">
            ...
            >
              ...
              <div className="relative w-full max-w-sm">
                <div className="w-full bg-transparent backdrop-blur-xl border border-white/40 rounded-[2rem] p-8 flex flex-col items-center shadow-2xl relative overflow-hidden">
                  ...
                  {/* Confirm Button */}
                  <button 
                    onClick={() => alert("Onboarding Complete! (This is a prototype)")}
                    className="w-full py-3.5 bg-white text-black rounded-xl font-bold text-[15px] hover:bg-[#e8f5e9] transition-all active:scale-[0.98] shadow-lg shadow-white/5 hover:shadow-white/10 flex items-center justify-center gap-2"
                  >
